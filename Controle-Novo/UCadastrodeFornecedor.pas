...
begin
   ...
   Writeln(F,'<Html>');
   writeln(F,'<Head>');
   writeln(F,'<Title>Relátorio de Fornecedores</Title>');
   writeln(F,'</Head>');
   writeln(F,'<Body>');
   writeln(F,'<H2><Center>Relatório de Fornecedores</CENTER><H2>');
   WRITELN(F,'<p><p>');
   writeln(F,'<Table Border=1 width=100%>');
   writeln(F,'<TR>');
   writeln(F,'<TD>Nome</TD>');
   writeln(F,'<TD>Telefone</TD>');
   writeln(F,'<TD>Endereço</TD>');
...
begin
  ...
  begin
    ShowMessage('O campo Telefone não pode estar em branco!');
  ...
  begin
    ShowMessage('O campo Endereço não pode estar em branco!');
  ...
  begin
    ShowMessage('O campo Cidade não pode estar em branco!');
    DBECidade.SetFocus;
    Abort;
  end;
  ...
  begin
    ShowMessage('O campo Estado não pode estar em branco!');
    DBCBEstado.SetFocus;
    Abort;
  end;
   end;
